...
![Настройки предпочтений](./settings.jpg)
...
![Еженедельная доступность](./availability.jpg)

*На изображении показан интерфейс выбора времени, когда пользователь доступен для быстрых знакомств.*

---

#### Улучшение 3: Подтверждение сохранения данных

**Стало (После):**

* После сохранения выбранного времени отображается сообщение **"Availability saved."**
* Это уведомление подтверждает, что изменения успешно сохранены.

![Подтверждение сохранения](./saved.jpg)

*На изображении отображается зелёное уведомление, подтверждающее успешное сохранение выбранной доступности.*
