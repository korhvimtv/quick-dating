...
Тип развёртывания - нераспределённый. Приложение будет развернуто на одном сервере, в одном экзеспляре с помощью метода BIG BOOM (одномоментное развертывание)
